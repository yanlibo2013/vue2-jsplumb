...
!function(a, b) {
    ...
    g.prototype = {
        ...
        getTransform: function(a) {
            var c = this.$set
              , d = c[0];
            return a ? this.setTransform(a) : (a = b.style(d, "transform"),
        ...
        setMatrix: function(a, c) {
            if (!this.disabled) {
                ...
                if (e) {
                    var f = c.dims;
                    f || (this.resetDimensions(),
                    f = this.dimensions);
                    var g, h, i, j = this.container, k = f.width, l = f.height, m = j.width, n = j.height, o = m / k, p = n / l;
                    "center" !== this.$parent.css("textAlign") || "inline" !== b.css(this.elem, "display") ? (i = (k - this.elem.offsetWidth) / 2,
                    g = i - f.border.left,
                    h = k - m - i + f.border.right) : g = h = (k - m) / 2;
                    var q = (l - n) / 2 + f.border.top
                      , r = (l - n) / 2 - f.border.top - f.border.bottom;
                    "invert" === e || "automatic" === e && o < 1.01 ? a[4] = Math.max(Math.min(a[4], g - f.border.left), -h) : a[4] = Math.min(Math.max(a[4], g), -h),
                    "invert" === e || "automatic" === e && p < 1.01 ? a[5] = Math.max(Math.min(a[5], q - f.border.top), -r) : a[5] = Math.min(Math.max(a[5], q), -r)
                }
                if ("skip" !== c.animate && this.transition(!c.animate),
                ...
                return this.setTransform("matrix(" + a.join(",") + ")"),
                this.scale = d,
        ...
        zoom: function(a, c) {
            ...
            if (!d.disableZoom) {
                var g = !1
                  ...
                  , i = +h[0];
                "number" != typeof a && (a = d.linearZoom ? i + d.increment * (a ? -1 : 1) : a ? i / (1 + d.increment) : i * (1 + d.increment),
                g = !0),
                a = Math.max(Math.min(a, d.maxScale), d.minScale);
                var j = d.focal;
                if (j && !d.disablePan) {
                    this.resetDimensions();
        ...
        _initStyle: function() {
            ...
            this.$set.css(a);
            var c = this.$parent;
            c.length && !b.nodeName(this.parent, "body") && (a = {
                overflow: "hidden"
            },
        ...
        _bind: function() {
            ...
            c.disablePan && c.disableZoom || (i[f] = function(b) {
                if (!c.ignoreChildrensEvents || b.target === this) {
                    var d;
                    ("touchstart" === b.type ? !(d = b.touches || b.originalEvent.touches) || (1 !== d.length || c.disablePan) && 2 !== d.length : c.disablePan || (b.which || b.originalEvent.which) !== c.which) || (b.preventDefault(),
                    b.stopPropagation(),
                    a._startMove(b, d))
                }
            }
        ...
        _startMove: function(a, d) {
            if (!this.panning) {
                var e, f, g, i, j, k, l, m, n = this, o = this.options, p = o.eventNamespace, q = this.getMatrix(), r = q.slice(0), s = +r[4], t = +r[5], u = {
                    matrix: q,
                    animate: "skip"
                }, v = a.type;
                "pointerdown" === v ? (e = "pointermove",
                f = "pointerup") : "touchstart" === v ? (e = "touchmove",
                f = "touchend") : "MSPointerDown" === v ? (e = "MSPointerMove",
                f = "MSPointerUp") : (e = "mousemove",
                f = "mouseup"),
                e += p,
                f += p,
                this.transition(!0),
                ...
                var x = function(a) {
                    ...
                    b || (b = a),
                    n.pan(s + b.pageX - k, t + b.pageY - l, u)
                };
